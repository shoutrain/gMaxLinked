...
public:
    ...
    ub4_ getTotalSize() const { return _totalSize; }

    ub4_ getActualSize() const { return _actualSize; }

    ub4_ getFreeSize() const { return _freeSize; }

    ub4_ getUsedSize() const { return _usedSize; }
