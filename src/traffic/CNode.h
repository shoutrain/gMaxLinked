...
public:
    ...
    const c1_ *getIp() const { return _ip; }

    ub2_ getPort() const { return _port; }

    b4_ getFd() const { return _fd; }

    CTransaction *getTransaction() { return &_transaction; }

    CNodeGroup *getGroup() { return _group; }
